  ...
  return async (req, res, next) => {
    ...
    try {
      ...
      if (cachedResponse) {
        ...
        // Set proper content-type before sending cached response
      ...
      res.json = function(data) {
        ...
        // Set proper content-type before processing
        ...
        if (res.statusCode >= 200 && res.statusCode < 300) {
          ...
          const cacheData = {
            ...
            headers: {
              'Content-Type': this.get('Content-Type') || 'application/json; charset=utf-8'
            }
          };
