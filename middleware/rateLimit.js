...
exports.apiLimiter = rateLimit(
  createLimiterOptions({
    ...
    max: 550, // Limit each IP to 550 requests per windowMs
...
exports.adminLimiter = rateLimit(
  createLimiterOptions({
    windowMs: 60 * 60 * 1000, // 1 hour
    max: 1000, // Limit each admin to 500 operations per hour
...
/**
 * Ticket verification rate limiter
 * To prevent abuse of ticket verification system
 */
exports.ticketVerificationLimiter = rateLimit(
  createLimiterOptions({
    windowMs: 5 * 60 * 1000, // 5 minutes
    max: 100, // Limit each IP to 100 ticket verifications per 5 minutes
    message: 'Too many ticket verification attempts, please try again in 5 minutes',
    prefix: 'rate-limit:ticket-verify:'
  })
);
